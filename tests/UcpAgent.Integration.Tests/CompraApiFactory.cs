...
file sealed class MockSearchService : ISearchService
{
...
file sealed class MockCartService : ICartService
{
...
file sealed class MockCheckoutService : ICheckoutService
{
...
file sealed class MockOrderService : IOrderService
{
